...
Link to 3D printing files on Makerworld: [Link](https://makerworld.com/de/models/2982996-plant-watering-system-esp32#profileId-3347076)
...
- Download *.3mf file for the Plant Watering System Project on Makerworld: [Link](https://makerworld.com/de/models/2982996-plant-watering-system-esp32#profileId-3347076)
...
Once you have connected the silicon hoses to the pumps, start manual mode and fill the pipes for each pump with water so that they are ready for use with no air remaining in the hoses.
...
![Watering](https://github.com/Eccodyne/Plant-Watering-System/blob/main/Images/Watering.JPG)
